...
class PayGateDotTo_Crypto_Payment_Gateway_Wbtcoptimism extends WC_Payment_Gateway {
...
$paygatedottocryptogateway_wbtcoptimism_response_minimum = wp_remote_get('https://api.paygate.to/crypto/optimism/wbtc/info.php', array('timeout' => 30));
if (is_wp_error($paygatedottocryptogateway_wbtcoptimism_response_minimum)) {
    ...
    $paygatedottocryptogateway_wbtcoptimism_body_minimum = wp_remote_retrieve_body($paygatedottocryptogateway_wbtcoptimism_response_minimum);
    $paygatedottocryptogateway_wbtcoptimism_conversion_resp_minimum = json_decode($paygatedottocryptogateway_wbtcoptimism_body_minimum, true);
    if ($paygatedottocryptogateway_wbtcoptimism_conversion_resp_minimum && isset($paygatedottocryptogateway_wbtcoptimism_conversion_resp_minimum['minimum'])) {
        $paygatedottocryptogateway_wbtcoptimism_final_minimum = sanitize_text_field($paygatedottocryptogateway_wbtcoptimism_conversion_resp_minimum['minimum']);
        if ($paygatedottocryptogateway_wbtcoptimism_payin_total < $paygatedottocryptogateway_wbtcoptimism_final_minimum) {
...
if (is_wp_error($paygatedottocryptogateway_wbtcoptimism_gen_wallet)) {
 ...
 // Check if decoding was successful
    if ($paygatedottocryptogateway_wbtcoptimism_wallet_decbody && isset($paygatedottocryptogateway_wbtcoptimism_wallet_decbody['address_in'])) {
        ...
        $paygatedottocryptogateway_wbtcoptimism_gen_ipntoken = wp_kses_post($paygatedottocryptogateway_wbtcoptimism_wallet_decbody['ipn_token']);
...
function paygatedotto_add_instant_payment_gateway_wbtcoptimism($gateways) {
    $gateways[] = 'PayGateDotTo_Crypto_Payment_Gateway_Wbtcoptimism';
    return $gateways;
}

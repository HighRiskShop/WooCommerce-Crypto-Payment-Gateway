...
class HighRiskShop_Crypto_Payment_Gateway_Usdcsol extends WC_Payment_Gateway {
...
function paygatedotto_add_instant_payment_gateway_usdcsol($gateways) {
    $gateways[] = 'HighRiskShop_Crypto_Payment_Gateway_Usdcsol';
    return $gateways;
}
...
function paygatedottocryptogateway_usdcsol_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_usdcsolexpected_coin = $order->get_meta('paygatedotto_usdcsol_payin_amount', true);
...
$order->add_order_note(sprintf( __( '[Order Failed] Customer sent %1$s %2$s instead of %3$s sol_usdc. TXID: %4$s', 'crypto-payment-gateway' ), $paygatedottocryptogateway_usdcsolpaid_value_coin, $paygatedottocryptogateway_usdcsol_paid_coin_name, $paygatedottocryptogateway_usdcsolexpected_amount, $paygatedottocryptogateway_usdcsol_paid_txid_in));
		...
		$order->update_status('processing', sprintf( __( '[Payment completed] Customer sent %1$s %2$s TXID:%3$s', 'crypto-payment-gateway' ), $paygatedottocryptogateway_usdcsolpaid_value_coin, $paygatedottocryptogateway_usdcsol_paid_coin_name, $paygatedottocryptogateway_usdcsol_paid_txid_in));

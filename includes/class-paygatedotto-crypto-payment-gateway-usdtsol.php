...
class HighRiskShop_Crypto_Payment_Gateway_Usdtsol extends WC_Payment_Gateway {
...
function paygatedotto_add_instant_payment_gateway_usdtsol($gateways) {
    $gateways[] = 'HighRiskShop_Crypto_Payment_Gateway_Usdtsol';
    return $gateways;
}
...
function paygatedottocryptogateway_usdtsol_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_usdtsolexpected_coin = $order->get_meta('paygatedotto_usdtsol_payin_amount', true);
